...
model_path=r'D:\TRAINING_DATA_FINAL\Model_fullsize_checkpoints\checkpoint_epoch_99.pt'
...
for i in range(1):
    ...
    clustermap=np.zeros((1344,1344))
    torch_prediction=torch_prediction2.reshape(5,1344,1344).detach().cpu() #reshape to 5 channels and detach and cpu
